...
public class PasswordField extends VBox
{
    ...
    {
        super(10); // add spacing
        getChildren().add(passwordField);

        // add eye icon to text field and password field
        ...
        // show icons only when text field filled
    ...
    /**
     * workaround to select the next node when a Tab key was clicked
     */
